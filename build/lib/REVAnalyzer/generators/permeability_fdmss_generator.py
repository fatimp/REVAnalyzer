...
def generate_permeability_fdmss(inputdir, image, directions, size, cut_step, sREV_max_size, exe_path_fdmss, n_threads=1, resolution=1., outputdir='output', show_time=False):
    ...
    for direction in directions_list:
        ...
        image_path = '--image='+os.path.join(inputdir, image)
        ...
        image_ar = _read_array(os.path.join(
            inputdir, image), size, 'uint8').astype(bool)
