...
def generate_permeability_mef(inputdir, image, directions, size, cut_step, sREV_max_size, exe_path_ccm, exe_path_mef, exe_mef, n_threads=1, resolution=1., length_unit_type='UM', outputdir='output', show_time=False):
    ...
    for direction in directions_list:
        statoildir = generate_PNM(inputdir, image, size, cut_step, sREV_max_size, exe_path_ccm,
                                  n_threads, resolution, length_unit_type, direction, outputdir, show_time)
