# -*- coding: utf-8 -*-
"""
Definition of Euler Density II metric. The Euler density here is extracted from PNM characteristics, it is computed as the difference between pore and throat numbers, normalized over subsample volume.
"""
